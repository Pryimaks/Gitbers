...
namespace Gitbers.Migrations
{
    ...
    [Migration("20260914224439_AddTeamFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gitbers.Data.GitHubActivity", b =>
                {
            ...
            modelBuilder.Entity("Gitbers.Data.MetricSnapshot", b =>
                {
            ...
            modelBuilder.Entity("Gitbers.Data.Notification", b =>
                {
            ...
            modelBuilder.Entity("Gitbers.Data.Role", b =>
                {
            ...
            modelBuilder.Entity("Gitbers.Data.Team", b =>
                {
                    b.Property<int>("TeamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gitbers.Data.TeamMember", b =>
                {
                    b.Property<int>("TeamMemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gitbers.Data.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gitbers.Data.GitHubActivity", b =>
                {
                    b.HasOne("Gitbers.Data.TeamMember", "TeamMember")
                        .WithMany()
            ...
            modelBuilder.Entity("Gitbers.Data.MetricSnapshot", b =>
                {
                    b.HasOne("Gitbers.Data.Team", "Team")
            ...
            modelBuilder.Entity("Gitbers.Data.Notification", b =>
                {
                    b.HasOne("Gitbers.Data.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Gitbers.Data.User", b =>
                {
                    b.HasOne("Gitbers.Data.Role", "Role")
                        .WithMany("Users")
